...
5. Install the MIT App Inventor app on your Android device and connect to the ESP32.
6. Use the app to monitor color detection and send manual control commands.
